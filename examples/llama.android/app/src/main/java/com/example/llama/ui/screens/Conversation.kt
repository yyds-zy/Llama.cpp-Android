...
import com.example.llama.data.defaultSystem
import com.example.llama.lmloader.LMHolder
import com.example.llama.ui.components.Input
import com.example.llama.ui.components.message.BotMessage
import com.example.llama.ui.components.message.TextResponse
import com.example.llama.ui.components.message.UserMessage
import com.example.llama.util.ChatMLUtil
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.launch
import kotlin.math.max

// todo fix model name  qwen2_pruned_0.5_4-25.gguf
@Composable
fun Conversation(
            ...
            Box(
                ...
                Input(
                    ...
                    onTextSend = { str ->
                        ...
                        Log.d("xuezhiyuan Conversation", txt)
